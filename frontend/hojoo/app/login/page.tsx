  ...
  const onSubmit: SubmitHandler<Inputs> = (data) => {
    ...
    fetch('http://localhost:8080/api/auth/login', {
      ...
      .then((data) => {
        ...
        alert(data.message + '님 환영합니다.');
        setCookie({}, 'accessToken', data.accessToken, { httpOnly: false, path: '/' })
        setCookie({}, 'refreshToken', data.refreshToken, { httpOnly: false, path: '/' })
        router.push('/')
      })
...
<div className="font-[sans-serif] text-[#333]">
  <div className="min-h-screen flex fle-col items-center justify-center py-6 px-4">
    <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
      ...
      <form className="space-y-6 max-w-md md:ml-auto max-md:mx-auto w-full" onSubmit={handleSubmit(onSubmit)}>
